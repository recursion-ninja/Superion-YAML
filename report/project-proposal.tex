...
To gauge on what expense did our fuzzers managed to perform input generation, we have also produced a quantitative analysis of the execution speed of each.
...
\section*{Discussion}
We found that Superion created a more clear and concise input than Gramatron, which was disorganized. Superion created an input that was similar to what we were looking for.
