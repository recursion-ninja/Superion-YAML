...
Instead the same methodology was applied to compare substitute tools, ALF and AFL++.
We will discuss the difficulties presented by each initial tool, our efforts to address these difficulties, as well as the refocusing of our methodology to new fuzzing tools and the comparative efficacy of these tools with respect to the CVE corpus replication.
