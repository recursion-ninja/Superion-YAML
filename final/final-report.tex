...
\begin{figure}
	\centering
	\includegraphics[scale=1.0, trim={0 0 0 0}, clip]{yaml-sample-crashes.png}
	\caption{yaml-cpp crashes}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[scale=1.0, trim={0 0 0 0}, clip]{yamlsamplecrashcat.png}
...
\begin{figure}
	\centering
	\includegraphics[scale=1.0, trim={0 0 0 0}, clip]{markdowncrashes.png}
