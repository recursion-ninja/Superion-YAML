...
\begin{center}
	...
	\textbf{Figure 2.} Fuzzing yaml-cpp with AFL++\\
\vspace{6mm}
	\includegraphics[scale=0.45, trim={0 3cm 0 0}, clip]{yaml_cpp_crashes.jpg}\\
	\textbf{Figure 2.} yaml-cpp crashes\\
\vspace{6mm}
	\includegraphics[scale=1.0]{yamlsamplecrashcat.png}\\
	\textbf{Figure 2.} Content of a Sample yaml-cpp crash\\
\vspace{6mm}
	\includegraphics[scale=0.7, trim={0 0 1.5cm 0}, clip]{markdownfuzzer.png}\\
	\textbf{Figure 2.} Fuzzing markdown with AFL++ for 3 hours.\\
\end{center}
\vspace{6mm}
...
\begin{center}
	...
	\textbf{Figure 2.} Markdown Crashes\\
\vspace{6mm}	
	\includegraphics[scale=1.0]{markdownsamplecatcrash.png}\\
	\textbf{Figure 2.} Content of a Sample markdown crash\\
\end{center}
\vspace{6mm}
