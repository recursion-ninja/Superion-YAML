...
While both projects are open source and are modular in their design for incorporating new grammars, the ease of this incorporation was misguided.
Neither extension was fully successful.
However, there the extension attempts did provide insightful results.

Qualitatively, we have composed a corpus of CVEs discovered from previous work.
