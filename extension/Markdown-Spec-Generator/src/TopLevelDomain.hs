...
newtype TopLevelDomain = TLD Int
  deriving newtype (Eq, Ord)
  deriving stock   (Data, Typeable, Generic)


instance Bounded TopLevelDomain where
...
instance Enum TopLevelDomain where
...
instance Ix TopLevelDomain where
...
instance HasNonTerminal TopLevelDomain where
    ...
    nonTerminal = const "TOPLEVELDOMAIN"
...
instance HasRuleByValue TopLevelDomain where
    ...
    ruleOfValue = const $ ruleNadaDeps . fromList . pure . term . Terminal . Right . topLevelDomain


instance HasSuffixSymbol TopLevelDomain where

    suffix = nonTerminal


instance IsGrammar TopLevelDomain where
